...
type ImageAPIClient interface {
	...
	ImageLoad(ctx context.Context, input io.Reader, quiet bool, printExcludes bool) (types.ImageLoadResponse, error)
	...
	ImageSave(ctx context.Context, images []string, excludeIDs []string) (io.ReadCloser, error)
